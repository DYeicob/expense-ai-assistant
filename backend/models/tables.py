...
class Expense(Base):
    ...
    merchant = Column(String(255))  # Shop/merchant name
    ...
    image_path = Column(String(500))  # Path to receipt image
    confidence = Column(Float)  # OCR/classifier confidence score
